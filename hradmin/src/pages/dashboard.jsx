...
export default function Dashboard() {
  ...
  const stats = [
    {
      iconClass: 'blue', label: 'Total Faculty', value: '128',
    ...
    {
      iconClass: 'amber', label: 'Pending Reviews', value: '34',
    ...
    {
      iconClass: 'green', label: 'Completed', value: '89',
    ...
    {
      iconClass: 'red', label: 'Deadline', value: 'Mar 15',
        ...
        <div className="content">
          ...
          <div className="history-card">
            ...
            <div className="history-grid">
              {history.map((h) => <HistoryItem key={h.title} {...h} />)}
            </div>
          </div>
        </div>
      </div>
